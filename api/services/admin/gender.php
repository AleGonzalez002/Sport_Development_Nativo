    ...
    if (isset($_SESSION['idAdministrador'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (!$genero->setNombre($_POST['NombreGenero'])) {
                    $result['error'] = $$genero->getDataError();
                } elseif ($genero->createRow()) {
                    $result['status'] = 1;
                    $result['message'] = 'Nuevo genero agregado correctamente';
                } else {
                    $result['error'] = $genero->getDataError() ?: 'Ocurrió un problema al agregar el nuevo color.';
                }
                break;
            ...
            case 'readAll':
                if ($result['dataset'] = $genero->readAll()) {
                    ...
                    $result['error'] = 'No existen generos registrados';
                }
                break;
            case 'readOne':
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$genero->setNombre($_POST['NombreGenero'])
                ) {
                    $result['error'] = $genero->getDataError();
