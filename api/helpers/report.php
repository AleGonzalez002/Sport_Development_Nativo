...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/Sport_Development_3/views/admin/';
    ...
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['idAdministrador'])) {
            ...
            $this->setTitle('Sport_Development - Reporte', true);
    ...
    public function header()
    {
        ...
        $this->cell(166, 10, 'Fecha/Hora: ' . date('d-m-Y   h:i: A'), 0, 1, 'C');
