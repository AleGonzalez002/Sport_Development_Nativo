...
document.addEventListener('DOMContentLoaded', () => {
    ...
    MAIN_TITLE.textContent = 'Gestionar Colores';
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <!-- Botón de editar -->
                        <button type="button" class="btn btn-outline-success btn-sm mx-1" title="Editar" onclick="openUpdate(${row.id_color})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                        <!-- Botón de eliminar -->
                        <button type="button" class="btn btn-outline-danger btn-sm mx-1" title="Eliminar" onclick="openDelete(${row.id_color})">
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        ...
        ID_DEPA.value = ROW.id_color;
        NOMBRE_DEPA.value = ROW.nombre;
    } else {
        sweetAlert(2, DATA.error, false);
    }
}
...
const openReport = () => {
    ...
    const PATH = new URL(`${SERVER_URL}reports/admin/color.php`);
